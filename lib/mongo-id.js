...
MongoID.ObjectID.prototype.toString = () => {
  let self = this;
  return 'ObjectID("' + self._str + '")';
};

MongoID.ObjectID.prototype.equals = other => {
  let self = this;
  return (
...
MongoID.ObjectID.prototype.clone = () => {
  let self = this;
  return new MongoID.ObjectID(self._str);
};

MongoID.ObjectID.prototype.typeName = () => {
  return 'oid';
};

MongoID.ObjectID.prototype.getTimestamp = () => {
  let self = this;
  return parseInt(self._str.substr(0, 8), 16);
};

MongoID.ObjectID.prototype.valueOf = MongoID.ObjectID.prototype.toJSONValue = MongoID.ObjectID.prototype.toHexString = () => {
  return this._str;
};

EJSON.addType('oid', str => {
